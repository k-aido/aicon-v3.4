...
export const mockElements: Record<string, CanvasElement> = {
  'content-1': {
    ...
    thumbnail: 'https://via.placeholder.com/320x180?text=React+Hooks+Tutorial&bg=ff0000&color=ffffff',
    platform: 'youtube',
  ...
  'content-2': {
    ...
    thumbnail: 'https://via.placeholder.com/280x220?text=CSS+Grid+Tricks&bg=000000&color=ffffff',
    platform: 'tiktok',
    duration: 45,
    viewCount: 120000,
    likeCount: 12000,
  ...
  'content-3': {
    ...
    thumbnail: 'https://via.placeholder.com/300x200?text=Design+Systems&bg=E4405F&color=ffffff',
    platform: 'instagram',
    viewCount: 85000,
    likeCount: 3200,
    commentCount: 180,
